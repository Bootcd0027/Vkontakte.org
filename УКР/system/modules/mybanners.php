		...
		default:
			...
			if($sql_){
				...
				foreach($sql_ as $row){
					...
					if($row['pos'] == 1) $tpl->set('{pos}', 'Верх 880х150');
					elseif($row['pos'] == 2) $tpl->set('{pos}', 'Низ 880х150');
