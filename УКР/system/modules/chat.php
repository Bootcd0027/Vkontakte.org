			...
			$tpl->load_template('chat/msg.tpl');
				...
				if($row) {
					...
					$text = replase_smile($text);
						...
						<div id=\''.$new.'\' style=\'float:left;width:565px;background: '.$newcom.';border-bottom: solid 1px #c9c9c9;border-right: solid 1px #c9c9c9;border-top: solid 1px #c9c9c9;border-left: solid 1px #c9c9c9;-moz-border-radius: 2px;-webkit-border-radius: 2px;border-radius: 2px;padding: 10px;margin-bottom: 5px;margin-top:5px;\'>
		...
		default:
			...
			$tpl->load_template('chat/main.tpl');
				...
				if($row) {
					...
					$text = replase_smile($text);
                        $workcom .= '<div class=\'fotocom\' style=\'margin-bottom:5px;\' id=\'comment_'.$row_com['id'].'\'><div class=\'ava_mini\' style=\'float:left;width:60px\'><a href=\'/u'.$row_com['user_id'].'\' onclick="Page.Go(this.href); return false"><img src=\''.$avau.'\' style=\'border-radius: 5px;\'></a></div>
						<div style=\'float:left;width:565px;background: #fff;border-bottom: solid 1px #c9c9c9;border-right: solid 1px #c9c9c9;border-top: solid 1px #c9c9c9;border-left: solid 1px #c9c9c9;-moz-border-radius: 2px;-webkit-border-radius: 2px;border-radius: 2px;padding: 10px;margin-bottom: 5px;margin-top:5px;\'>
