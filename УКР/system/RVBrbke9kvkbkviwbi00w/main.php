...
echoblock('Значки', 'Добавление, удаление значков', 'znachok', 'znachok');
...
echoblock('Верификация '.$new_z.'', 'Заявки на верификацию аккаунтов', 'ver', 'ver');
...
$.post('/Gjfwokvokw4693pvkomwew30tBsjivjOEOKfek.php', {act: 'send'});
});
</script>
HTML;
echohtmlend();
