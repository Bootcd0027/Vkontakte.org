...
.tefolfer{background:url("/system/RVBrbke9kvkbkviwbi00w/images/directory.png") no-repeat 3px 3px;padding:5px;height:15px;padding-left:24px;cursor:pointer;color:#444;padding-top:3px;font-family:Verdana;}
.tefolfer:hover{background:#c8e5f5 url("/system/RVBrbke9kvkbkviwbi00w/images/directory.png") no-repeat 3px 3px;}
.tetpl{background:url("/system/RVBrbke9kvkbkviwbi00w/images/html.png") no-repeat 3px 3px;padding:5px;height:15px;padding-left:24px;padding-top:3px;cursor:pointer;color:#444;font-family:Verdana;}
.tetpl:hover{background:#c8e5f5 url("/system/RVBrbke9kvkbkviwbi00w/images/html.png") no-repeat 3px 3px;}
.tecss{background:url("/system/RVBrbke9kvkbkviwbi00w/images/css.png") no-repeat 3px 3px;padding:5px;height:15px;padding-top:3px;padding-left:24px;cursor:pointer;color:#444;font-family:Verdana;}
.tecss:hover{background:#c8e5f5 url("/system/RVBrbke9kvkbkviwbi00w/images/css.png") no-repeat 3px 3px;}
.tejs{background:url("/system/RVBrbke9kvkbkviwbi00w/images/script.png") no-repeat 3px 3px;padding:5px;height:15px;padding-top:3px;padding-left:24px;cursor:pointer;color:#444;font-family:Verdana;}
.tejs:hover{background:#c8e5f5 url("/system/RVBrbke9kvkbkviwbi00w/images/script.png") no-repeat 3px 3px;}
...
#loading_text{color:#fff;position:relative;background: url("/system/RVBrbke9kvkbkviwbi00w/images/showb.png");width:250px;margin:auto;margin-top: 250px;padding:10px;font-size:11px;font-family:Verdana;border-radius:5px; -moz-border-radius:5px; -webkit-border-radius:5px;text-align:center;}
...
<div class="oneb">
<img src="/system/RVBrbke9kvkbkviwbi00w/images/{$icon}.png" alt="" title="" />{$title}
<div>{$description}</div>
</div>
</a>
HTML;
