...
if($_GET['act'] == 'upload'){
	...
	$image_rename = substr($image_name_2, 0, 40); // имя файла
...
<div id="prog_poster" style="display:none;margin-top:15px;margin-bottom:16px;background:url('/system/RVBrbke9kvkbkviwbi00w/images/progress_grad.gif');width:136px;height:18px;border:1px solid #006699;margin-left:230px"></div>
