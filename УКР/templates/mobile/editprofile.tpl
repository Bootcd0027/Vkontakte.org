...
[general]
<div class="tmenuf">
 <div><a href="/editmypage">{translate=editmyprofile_genereal}</a></div>
 <a href="/editmypage/contact">{translate=editmyprofile_contact}</a>
 <a href="/editmypage/interests">{translate=editmyprofile_interests}</a>
</div>
<div class="clr"></div>
<div class="infobl" id="info_save" style="display:none;font-weight:normal;"></div>
<div class="texta" style="margin-top:0px">{translate=lang_465}:</div>
 <div class="padstylej"><select id="sex" class="inp" onChange="sp.check()">
  <option value="0">- {translate=lang_72} -</option>
  {sex}
 </select></div>
<div class="mgclr"></div>
<div class="no_display" id="sp_block"><div class="texta">{translate=lang_73}:</div>
 <div class="padstylej">
