...
<div class="miniature_title fl_l apps_box_text">Облик профиля</div><a class="cursor_pointer fl_r" style="font-size:12px" onClick="viiBox.clos('fon_mouse', 1)">Закрыть</a>
