...
<div class="miniature_pos" style="width:620px;padding:0px;margin-top:20px">
<a class="fl_r tb_close" onClick="viiBox.clos('subscribes', 1)">Закрыть</a>
