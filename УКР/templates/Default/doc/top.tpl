...
<div class="fl_l margin_top_5">{translate=lang_56} {doc-num} <span id="langNumric"></span></div>
<div class="button_div_gray fl_r"><button id="upload_2">{translate=lang_293}</button></div>
<div class="clear"></div>
</div>
