<div class="doc_block" style="margin-left:0px;margin-right:0px" id="doc_block{did}">
 ...
 <div class="button_div fl_l"><button onClick="Doc.SaveEdit('{did}', 'editLnkDoc{did}')">{translate=lang_92}</button></div>
 <div class="button_div_gray fl_l margin_left"><button onClick="Doc.CloseEdit('{did}', 'editLnkDoc{did}')">{translate=lang_163}</button></div>
 </div>
 </div>
 <div class="doc_sel" onClick="Doc.ShowEdit('{did}', this.id)" id="editLnkDoc{did}">{translate=lang_34}</div>
 <div class="doc_date clear">{size}, {translate=lang_239} {date}</div>
 <div class="clear"></div>
</div>