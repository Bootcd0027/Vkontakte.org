...
<div class="buttonsprofile albumsbuttonsprofile" style="height:22px;">
		 <div class="button_div " style="margin-top:10px;text-align:center;"><button id="fast_buts_{user2-id}" onClick="Compare.choose_send({user2-id}); return false;" style="width:100%">{user2-name}</button></div></div>
		</div><br>
