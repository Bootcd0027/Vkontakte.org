<div class="search_form_tab">
 <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="height:15px">
  ...
  <div class="buttonsprofileSec"><a href="/settings/blacklist" onClick="Page.Go(this.href); return false;"><div>Черный список</div></a></div>
...
[yes-users]<div class="margin_top_10" style="margin-top:12px;"></div><div class="allbar_title_black"><span style="margin-left:10px;">В Вашем черном списке находится {cnt}</span></div>[/yes-users]
