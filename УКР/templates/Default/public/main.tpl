	...
	$(window).scroll(function(){
		if($('#type_page').val() == 'public'){
			...
			if($(window).scrollTop() > $('#fortoAutoSizeStyle').offset().top && !startResizeCss){
				startResizeCss = true;
				$('body').append('<div id="addStyleClass"><style type="text/css" media="all">.public_wall{width:700px}.infowalltext_f{font-size:11px}.wall_inpst{width:614px}.public_likes_user_block{margin-left:523px}.wall_fast_opened_form{width:625px}.wall_fast_block{width:621px;margin-top:2px}.public_wall_all_comm{width:620px;margin-top:2px;margin-bottom:5px}.player_mini_mbar_wall{width:637px;margin-bottom:0px}#audioForSize{min-width:637px}.wall_rec_autoresize{width:635px}.wall_fast_ava img{width:50px}.wall_fast_ava{width:60px}.wall_fast_comment_text{margin-left:57px}.wall_fast_date{margin-left:57px;font-size:11px}.size10{font-size:11px}.public_like_strelka_groups {height: 9px;margin-left: 19px;margin-top: -3px;position: absolute;width: 120px}</style>');
			}
		}	
	});
...
<style>.newcolor000{color:#000}
.public_likes_user_block{margin-left:332px}</style>
...
<div class="cover_profile_bg cover_groups_bg">
 <div class="cover_buts_pos">
  ...
  <div class="cover_loaddef_bg {cover-param}" {cover-param-4}>
   ...
   <div id="les10_ex2" {cover-param-5}><img src="{cover}" width="870" id="cover_img" /></div>
   <div id="cover_restart"></div>
  </div>
 </div>
</div>[/admin]
[not-admin][cover]<div class="cover_all_user"><img src="{cover}" width="870" id="cover_img" {cover-param-5} /></div>[/cover][/not-admin]
...
[admin]<div class="cover_newava" {cover-param-7}><img src="{photo}" id="ava" /></div>[/admin]
 ...
 <div class="menuleft" style="margin-top:5px">
  [admin]<a href="/" onClick="groups.editform(); return false"><div>Управление страницей</div></a>
...
<a href="/" onClick="groups.inviteBox('{id}'); return false"><div>Пригласить друзей</div></a>
  ...
  <div class="publick_subscblock">
   ...
   <div id="no" class="{no}" style="text-align:center;font-size: 12px;">
 ...
 <div style="margin-top:7px">
  <div class="{no-users}" id="users_block">
   <div class="public_vlock cursor_pointer" onClick="groups.subscribes_groups('{id}'); return false">Подписчики</div>
   <div class="public_bg">
...
<div id="users_block" class="public_vlock cursor_pointer {no-users}"><span id="fm_all_link" onClick="Page.Go('/public/audio{id}'); return false">Аудиозаписи</span>

</div>

[yesaudio]

<div id="fm_show_cmin"><span id="langNumric">всего {audio-num}</span></div>
...
[videos]<div class="public_vlock cursor_pointer" onClick="Page.Go('/public/videos{id}'); return false">Видеозаписи</div>
 <div class="public_bg">
  [yesvideo]<div class="video_publick_icon_b"></div><div class="color777 public_margbut">{videos-num} <span id="langNumricVide"></span></div>[/yesvideo]
  {videos}
...
<div class="profiewr" style="width:490px">
 <div id="public_editbg_container">
 <div class="public_editbg_container">
 <div class="fl_l" style="width:600px;margin-top:6px;">
 [admin]<div class="set_status_bg no_display" id="set_status_bg">
  <input type="text" id="status_text" class="status_inp" value="{status-text}" style="width:462px;" maxlength="255" onKeyPress="if(event.keyCode == 13)gStatus.set('', 1)" />
 ...
 <div class="public_title" id="e_public_title" style="height:14px">{title} {preal}</div>
 <div class="status">
  ...
  [city]<div class="flpodtext">Местоположение:</div> <div class="flpodinfo">{city}</div>[/city]
  [gtype]<div class="flpodtext">Тип сообщества:</div> <div class="flpodinfo">{gtype}</div>[/gtype]
 ...
 [admin]<div class="public_editbg fl_l no_display" id="edittab1">
  ...
  <div class="mgclr"></div>
  <div class="texta">Местоположение:</div>
 <div class="padstylej"><select id="city" class="inpst" onChange="sp.check()">
  <option value="0">- Не выбрано -</option>
  {city2}
 </select></div>
<div class="mgclr"></div>
<div class="texta">Тематика:</div> 
<div class="padstylej"><select id="gtype" class="inpst" onChange="sp.check()">
  <option value="0">- Не выбрано -</option>
  {gtype2}
 </select></div>
<div class="mgclr"></div>
 ...
 [admin]<a href="/forum{id}?act=new" onClick="Page.Go(this.href); return false" class="fl_r {no}" style="text-decoration:none"><div class="albtitle" style="border-bottom:0px;color:#607387">Новая тема</div></a>[/admin]
 <div class="clear"></div>{thems}<div class="clear"></div>[/discussion]
 <div class="albtitle_wall" style="border-bottom:0px">{rec-num}</div>
 [admin]<div class="newmes" id="wall_tab" style="border-bottom:0px;margin-bottom:-5px">
  ...
  <input type="text" class="wall_inpst" value="Что у Вас нового?" onMouseDown="wall.form_open(); return false" id="wall_input" style="margin:0px;width:462px" />

  <div class="no_display" id="wall_textarea">
   <textarea id="wall_text" class="wall_inpst wall_fast_opened_texta" style="width:462px"
   ...
   <div class="wall_attach_menu no_display" onMouseOver="wall.attach_menu('open', 'wall_attach', 'wall_attach_menu')" onMouseOut="wall.attach_menu('close', 'wall_attach', 'wall_attach_menu')" id="wall_attach_menu" style="margin-left:372px">
...
<div class="wall_attach_icon_video" id="wall_attach_link" onClick="wall.attach_addvideo()">Видеозапись</div>
 ...
 <div class="cursor_pointer {wall-page-display}" onClick="groups.wall_page('{id}'); return false" id="wall_all_records"><div class="public_wall_all_comm" id="load_wall_all_records" style="margin-left:0px;width:630px">к предыдущим записям</div></div>
