...
<div id="Xjquery_jplayer"></div>
 ...
 <div class="staticPlbgTitle">
  ...
  <div class="staticpl_translate" onclick="player.noTranslate()" onmouseover="myhtml.title('1', 'Транслировать на мою страницу', 'xPlayerTranslate')" id="xPlayerTranslate1"></div>
