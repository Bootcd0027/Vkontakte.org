...
<div class="buttonsprofile albumsbuttonsprofile" style="height:10px"><div class="activetab"><a href="/im" onClick="Page.Go(this.href); return false;"><div>Диалоги</div></a></div>[dialog_owner]<a href="/messages" onClick="Page.Go(this.href); return false;">Просмотр диалогов</a>[/dialog_owner]<a href="/friends" onClick="Page.Go(this.href); return false;">К списку друзей</a></div><br><div class="clear"></div>
...
<div class="button_div fl_l msg_pad_top"><button onClick="messages.search(1); return false">Найти отправленные</button></div>
<div class="clear"></div>
</div>
