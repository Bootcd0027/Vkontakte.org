...
.pg1{width:500px;border:0px solid #eee;margin:auto;padding:20px;border-radius: 7px 7px 7px 7px;background:none repeat scroll 0 0 rgba(0, 0, 0, 0.3);line-height:18px;text-align:center;margin-top:100px;font-family:Tahoma;font-size:12px;color:#000}
...
<div class="pg1">
 ...
 <span style="color:#dddddd;">Мы просим всех пользователей привязать к странице свой номер <br /><b>мобильного телефона</b>. Это защитит Вашу страницу от угроз и избавит от необходимости постоянно вводить коды.</span><br /><br /><br />
