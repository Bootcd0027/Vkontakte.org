...
<input type="text" class="videos_input" style="width:656px" maxlength="65" id="title_n" value="{title}" />
...
<textarea class="videos_input wysiwyg_inpt" id="text" name="text" style="width:656px;height:300px">{text}</textarea>
<div class="input_hr"></div>
<div class="clear"></div>
