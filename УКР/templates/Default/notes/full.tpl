...
<div class="note_inf_panel note_text_full">
 <span class="online">{date}</span> &nbsp;|&nbsp; {comm-num} &nbsp;|&nbsp; <a class="cursor_pointer" onClick="Report.Box('note', '{note-id}')">Пожаловаться на блог</a>[owner]&nbsp;|&nbsp; <a href="/notes/edit/{note-id}" onClick="Page.Go(this.href); return false">Редактировать</a> &nbsp;|&nbsp; <a href="/" onClick="notes.delet({note-id}, 1); return false">Удалить</a>[/owner]
</div>
