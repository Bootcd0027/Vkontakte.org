...
<div class="videos_pad">
 ...
 <input type="text" class="videos_input fl_l" id="video_lnk" onKeyUp="videos.load()" style="margin-bottom:5px;width:380px" />
 <div class="button_div margin_left fl_l" style="margin-top:-33px;float:right;"><button onClick="videos.load()">&#8594;</button></div>
 <span id="vi_info">
  <span id="no_serviece">Видеосервис не поддерживается либо ссылка является неправильной<br /></span>
  Поддерживаемые видеосервисы: <b>Vkontakte</b>, <b>YouTube</b>, <b>RuTube.Ru</b>, <b>Vimeo.Com</b>
 </span>
