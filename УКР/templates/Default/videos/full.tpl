...
<div class="photo_close" onClick="videos.close({owner-id}, '{close-link}'); return false"></div>
 <div class="video_show_bg">
  <div class="video_show_object">
	...
	<div id="video_full_title_{vid}" class="fl_l tiiii">{title}</div>
   ...
   <div class="photo_rightcol">
	...
	[public]<div class="menuleft" style="width:220px;">
	 ...
	 <a onClick="Report.Box('video', '{vid}')"><img class="icon compla_ic" src="{theme}/images/spacer.gif" alt="" /><div>Пожаловаться на видеозапись</div></a>
	 	   [no-fave]<a onClick="fave.add({vid},3); return false" id="addfave_but"><img class="icon fav_ic" src="{theme}/images/spacer.gif" alt="" /><div><span id="text_add_fave">Добавить в закладки</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addfave_load" class="no_display" /></div></a>[/no-fave]
[yes-fave]<a onClick="fave.delet({vid},3); return false" id="addfave_but"><img class="icon fav_ic" src="{theme}/images/spacer.gif" alt="" /><div><span id="text_add_fave">Удалить из закладок</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addfave_load" class="no_display" /></div></a>[/yes-fave]
    </div>[/public]
   </div>
  <div class="clear"></div>
  </div>
