...
<div class="load_photo_quote">{translate=lang_111}</div>
<div class="load_photo_but"><div class="button_div fl_l"><button id="upload">{translate=lang_112}</button></div></div>
<small>{translate=lang_113}</small>
</div>