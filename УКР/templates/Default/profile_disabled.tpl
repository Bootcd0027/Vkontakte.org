...
<head>
<title>Страница не активирована</title>
 ...
 <div class="content" style="width:800px;">
  <div class="cont_border_left">
   <div class="cont_border_right">
    <div class="speedbar" id="speedbar">Страница не активирована</div>
    <div class="padcont">
	 <div class="info_center">На Ваш Email отправлено сообщение со ссылкой для активации. Перейдите по ссылке в сообщении и Ваш аккаунт будет активирован.</div>
	 <div class="clear"></div>
	</div>
   </div>
  </div>
