...
<a href="/balance?act=history" onClick="Page.Go(this.href); return false;"><div>История</div></a>
    <div class="buttonsprofileSec"><a href="/balance?act=invited" onClick="Page.Go(this.href); return false;"><div>Приглашённые друзья</div></a></div>
<a href="/balance?act=business" onClick="Page.Go(this.href); return false;"><div>Мои подарки</div></a>
 </div>
</div>
<div class="margin_top_10" style="margin-top:12px;"></div><div class="allbar_title_invite" style="margin-bottom:10px"><span style="margin-left:10px;">Последние 100 человек которых вы пригласили</span></div>