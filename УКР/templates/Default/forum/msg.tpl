...
<div class="forum_msg_ava">
 <a href="{alias}" onClick="Page.Go(this.href); return false"><img src="{ava}" width="50" height="50" /></a><br />
 {online}
</div>
<div class="forum_text">
 <a href="{alias}" onClick="Page.Go(this.href); return false"><b>{name}</b></a><br />
 {text}<br />
