...
<div class="clear"></div>
<div class="note_full_title" style="margin-top:1px">
...
<div class="forum_text">
 ...
 <div class="no_display" id="editTextTab">
  <textarea class="inpst" style="width:603px;height:120px" id="editText">{edit-text}</textarea>
...
<textarea 
	...
	id="fast_text_1" 
	style="width:603px;height:37px;color:#c1cad0;margin-left:3px;color:#000"
