...
<div style="background: #f5f5f5;padding: 10px;margin: 12px -12px -12px;border-radius: 0 0 5px 5px;">
<form method="post" name="guestbook">
<textarea name="message" class="videos_input wysiwyg_inpt fl_l im_msg_texta" id="textcom" style="width:560px;height:14px" placeholder="Введите Ваше сообщение.." onkeypress="if(event.keyCode == 10 || (event.keyCode == 13)) chatz.send()"></textarea>
