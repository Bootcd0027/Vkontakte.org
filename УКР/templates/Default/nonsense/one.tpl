...
<div class="nonsense_title">Победитель выиграл {prev_prize} голосов</div>
...
<div class="nonsense_info">
 ...
 Призовой фонд <b>{prize} голосов.</b><br />
 Участие стоит <b>{nonsense_one_cost} голосов.</b>
</div>
...
<div class="nonsense_info">
 ...
 <div class="err_red no_display" style="font-weight:normal;margin-top:25px;margin-bottom:0px;border:0px">У Вас <b>недостаточно</b> голосов. <a href="/balance" onClick="Page.Go(this.href); return false">Пополнить баланс</a></div>
 [game]<div style="width:120px;margin:auto" id="nonsenseButLogin"><div class="button_div fl_l" style="line-height:15px;margin-top:10px"><button id="nonsenseLogin" onClick="doLoad.data(3); nonsense.login()">Участвовать</button></div></div>[/game]
</div>
<div class="clear"></div>
