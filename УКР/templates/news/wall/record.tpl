[record]<div class="wallrecord wall_upage" id="wall_record_{rec-id}" style="padding: 15px 0 0;
background: transparent url('../images/feed_item_bg.png') repeat-y 20px 0;">
